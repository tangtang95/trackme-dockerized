...
/**
 * Advice for managing error about incompatible start and end date in a request
 */
@ControllerAdvice
public class IncompatibleDateAdvice {

    /**
     * An advice signaled into the body of the response that activates
     * only when the exception IncompatibleDateException is thrown.
    ...
    public @ResponseBody
    ExceptionResponseBody incompatibleDateException(IncompatibleDateException e) {
