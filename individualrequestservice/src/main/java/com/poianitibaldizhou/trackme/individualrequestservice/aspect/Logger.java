package com.poianitibaldizhou.trackme.individualrequestservice.aspect;
...
public class Logger {
     ...
     */
    @Around("execution(public * com.poianitibaldizhou.trackme.individualrequestservice.service.*.*(..))")
